...
const HumanResource = () => {
  const [generatedEmployeeId] = useState(() => generateEmployeeId());
  const readonlyEmployeeId = useMemo(() => generatedEmployeeId, [generatedEmployeeId]);
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="shadow-card border-border">
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-heading">System-generated Employee Identifier</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="max-w-sm space-y-2">
            <Label>Employee ID</Label>
            <Input value={readonlyEmployeeId} readOnly className="bg-slate-50 text-slate-700" />
          </div>
        </CardContent>
      </Card>
